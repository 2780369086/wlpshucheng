    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('books', models.ForeignKey(verbose_name='订单商品', to='bookstore.books.Books')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('addr', models.ForeignKey(verbose_name='收货地址', to='bookstore.users.Address')),
                ('passport', models.ForeignKey(verbose_name='下单账户', to='bookstore.users.Passport')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='order',
            field=models.ForeignKey(verbose_name='所属订单', to='bookstore.order.OrderInfo'),
        ),
    ]
