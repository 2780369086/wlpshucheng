...
class OrderInfo(BaseModel):
    ...
    passport = models.ForeignKey('bookstore.users.Passport', verbose_name='下单账户')
    addr = models.ForeignKey('bookstore.users.Address', verbose_name='收货地址')
...
class OrderGoods(BaseModel):
    ...
    books = models.ForeignKey('bookstore.books.Books', verbose_name='订单商品')
